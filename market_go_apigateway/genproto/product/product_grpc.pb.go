...
type ProductServiceClient interface {
	...
	GetById(ctx context.Context, in *Pkey, opts ...grpc.CallOption) (*Product, error)
	Create(ctx context.Context, in *ProductCreate, opts ...grpc.CallOption) (*Response, error)
...
func (c *productServiceClient) GetAll(ctx context.Context, in *GetListRequest, opts ...grpc.CallOption) (*GetListResponse, error) {
...
func (c *productServiceClient) GetById(ctx context.Context, in *Pkey, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
...
func (c *productServiceClient) Create(ctx context.Context, in *ProductCreate, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *productServiceClient) Delete(ctx context.Context, in *Pkey, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type ProductServiceServer interface {
	...
	GetById(context.Context, *Pkey) (*Product, error)
	Create(context.Context, *ProductCreate) (*Response, error)
...
func (UnimplementedProductServiceServer) GetAll(context.Context, *GetListRequest) (*GetListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAll not implemented")
}
func (UnimplementedProductServiceServer) GetById(context.Context, *Pkey) (*Product, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetById not implemented")
}
func (UnimplementedProductServiceServer) Create(context.Context, *ProductCreate) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedProductServiceServer) Delete(context.Context, *Pkey) (*Response, error) {
...
func _ProductService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetAll(ctx, req.(*GetListRequest))
	}
...
func _ProductService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetById(ctx, req.(*Pkey))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProductService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).Delete(ctx, req.(*Pkey))
	}
	return interceptor(ctx, in, info, handler)
}
